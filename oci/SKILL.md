...
4. Treat generic requests such as `create database`, `create VM cluster`, `list databases`, or `create PDB` as requests for the selected service, unless the user explicitly changes services.
...
| ExaDB-XS after it has been selected as the database service | `oci/database-cloud-services/exadb-xs/SKILL.md` |
...
- `oci/database-cloud-services/exadb-xs/SKILL.md`
