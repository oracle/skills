...
require_contains "$APEX_DIR/workspace/schema-mapping.md" 'Oracle AI Database 26ai' "workspace schema mapping handles 26ai-specific privileges"
require_contains "$APEX_DIR/workspace/schema-mapping.md" 'CREATE MLE' "workspace schema mapping includes CREATE MLE for 26ai MLE use"
require_contains "$APEX_DIR/workspace/schema-mapping.md" 'EXECUTE DYNAMIC MLE' "workspace schema mapping includes EXECUTE DYNAMIC MLE for 26ai MLE use"
