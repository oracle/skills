...
require_contains "$ROOT_SKILL" '^## Directory Structure$' "apex/SKILL.md documents directory structure"
require_contains "$ROOT_SKILL" '^## Category Routing$' "apex/SKILL.md documents category routing"
require_contains "$ROOT_SKILL" '^## Important Safety Rules$' "apex/SKILL.md documents important safety rules"
require_contains "$ROOT_SKILL" '^## DB Skill Usage Notices$' "apex/SKILL.md documents exact DB skill usage notices"
require_contains "$ROOT_SKILL" '^## User-Facing Safety Messages$' "apex/SKILL.md documents user-facing safety messages"
require_contains "$ROOT_SKILL" '^## Documentation Version Policy$' "apex/SKILL.md documents documentation version policy"
